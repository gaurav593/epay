...
public class TransactionBean implements Serializable{
	...
	public String depositTransaction(){
		if(service.getWebService().isBalanceCovered((Integer)user.getAccNumber(), new BigDecimal(transaction.getAmount()))){
			service.getWebService().transfer(48, user.getAccNumber(), transaction.getPurpose(), new BigDecimal(transaction.getAmount()));
